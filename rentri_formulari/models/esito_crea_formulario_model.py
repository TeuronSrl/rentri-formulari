...
class EsitoCreaFormularioModel(BaseModel):
    """
    EsitoCreaFormularioModel
    """
    esito: Optional[EsitoNuovoFormularioModel] = Field(default=None, description="Esito")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoCreaFormularioModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoCreaFormularioModel:
        """Create an instance of EsitoCreaFormularioModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoCreaFormularioModel.parse_obj(obj)

        _obj = EsitoCreaFormularioModel.parse_obj({
            "esito": EsitoNuovoFormularioModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
