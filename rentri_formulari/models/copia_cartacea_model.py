...
class CopiaCartaceaModel(BaseModel):
    ...
    mime: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Tipo MIME del file da caricare. Valori ammessi:  <ul><li><i>application/pdf</i></li><li><i>image/jpeg</i></li><li><i>image/png</i></li></ul>")
