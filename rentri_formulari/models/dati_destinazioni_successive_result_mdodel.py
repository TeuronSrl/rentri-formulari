...
class DatiDestinazioniSuccessiveResultMdodel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiDestinazioniSuccessiveResultMdodel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiDestinazioniSuccessiveResultMdodel:
        """Create an instance of DatiDestinazioniSuccessiveResultMdodel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiDestinazioniSuccessiveResultMdodel.parse_obj(obj)

        _obj = DatiDestinazioniSuccessiveResultMdodel.parse_obj({
