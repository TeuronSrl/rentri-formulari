...
class DatiTrasportoTrasmissioneBaseModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiTrasportoTrasmissioneBaseModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiTrasportoTrasmissioneBaseModel:
        """Create an instance of DatiTrasportoTrasmissioneBaseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiTrasportoTrasmissioneBaseModel.parse_obj(obj)
