...
class EsitoEstrazioneDatiXfirModel(BaseModel):
    """
    EsitoEstrazioneDatiXfirModel
    """
    esito: Optional[EsitoEstraiDatiXfirModel] = Field(default=None, description="Esito")
    ...
    __properties = ["esito", "tipo", "transazione_id", "validazione", "errore", "tempo_elaborazione"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoEstrazioneDatiXfirModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoEstrazioneDatiXfirModel:
        """Create an instance of EsitoEstrazioneDatiXfirModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoEstrazioneDatiXfirModel.parse_obj(obj)

        _obj = EsitoEstrazioneDatiXfirModel.parse_obj({
            "esito": EsitoEstraiDatiXfirModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
