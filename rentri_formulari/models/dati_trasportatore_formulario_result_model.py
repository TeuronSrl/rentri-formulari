...
class DatiTrasportatoreFormularioResultModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiTrasportatoreFormularioResultModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiTrasportatoreFormularioResultModel:
        """Create an instance of DatiTrasportatoreFormularioResultModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiTrasportatoreFormularioResultModel.parse_obj(obj)

        _obj = DatiTrasportatoreFormularioResultModel.parse_obj({
