...
class DatiDestinatarioFormularioSitoModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiDestinatarioFormularioSitoModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiDestinatarioFormularioSitoModel:
        """Create an instance of DatiDestinatarioFormularioSitoModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiDestinatarioFormularioSitoModel.parse_obj(obj)

        _obj = DatiDestinatarioFormularioSitoModel.parse_obj({
