...
class FirmaModel(BaseModel):
    ...
    firma: Union[Annotated[bytes, Field(min_length=1, strict=True)], Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Stringa in base64 contenente l'array di byte che costituisce la firma crittografica dell'hash. Per firme apposte con chiavi di tipo <i>ECC</i> la serializzazione della firma può essere sia secondo lo standard <i>SEC-1</i> che <i>IEEE P1363</i>")
