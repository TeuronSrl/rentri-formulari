...
class UploadXfirModel(BaseModel):
    ...
    UploadXfirModel
    """ # noqa: E501
    num_iscr_sito: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Numero iscrizione dell'unità locale")
    xfir: Union[StrictBytes, StrictStr] = Field(description="Contenuto del file xFIR")
    __properties: ClassVar[List[str]] = ["num_iscr_sito", "xfir"]
