...
class EsitoModel(BaseModel):
    ...
    __properties = ["tipo", "transazione_id", "validazione", "errore", "tempo_elaborazione"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoModel:
        """Create an instance of EsitoModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoModel.parse_obj(obj)

        _obj = EsitoModel.parse_obj({
            "tipo": obj.get("tipo"),
