...
class DatiTrasmissioneFormularioModel(BaseModel):
    ...
    dati_trasporto: Optional[List[DatiTrasportoTrasmissioneBaseModel2]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dati_trasporto": [DatiTrasportoTrasmissioneBaseModel2.from_dict(_item) for _item in obj["dati_trasporto"]] if obj.get("dati_trasporto") is not None else None,
