...
class ProduttoreItemResult(BaseModel):
    """
    Dati anagrafici riassuntivi riferiti ad un produttore  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProduttoreItemResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProduttoreItemResult:
        """Create an instance of ProduttoreItemResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProduttoreItemResult.parse_obj(obj)

        _obj = ProduttoreItemResult.parse_obj({
