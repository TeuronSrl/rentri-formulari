...
class IAnagrafica(BaseModel):
    """
    IAnagrafica
    """
    denominazione: Optional[StrictStr] = Field(default=None, description="Denominazione del soggetto")
    codice_fiscale: Optional[StrictStr] = Field(default=None, description="Codice fiscale del soggetto")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IAnagrafica:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IAnagrafica:
        """Create an instance of IAnagrafica from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IAnagrafica.parse_obj(obj)

        _obj = IAnagrafica.parse_obj({
