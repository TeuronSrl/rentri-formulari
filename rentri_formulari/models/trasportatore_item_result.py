...
class TrasportatoreItemResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["num_iscr_sito", "is_trasbordo_totale", "denominazione", "codice_fiscale"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.is_trasbordo_totale is None and "is_trasbordo_totale" in self.model_fields_set:
