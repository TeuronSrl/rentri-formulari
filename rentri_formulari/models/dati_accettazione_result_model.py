...
class DatiAccettazioneResultModel(BaseModel):
    ...
    """ # noqa: E501
    dati_firma: Optional[DatiFirmaResult] = Field(default=None, description="Dati relativi alla firma sui dati di accettazione")
    ...
    motivo_respingimento: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="Motivo di respingimento, richiesto per tipo accettazione R o P")
    ...
    __properties: ClassVar[List[str]] = ["dati_firma", "tipo_accettazione", "quantita_accettata", "causale_respingimento", "motivo_respingimento", "data_ora_arrivo", "attesa_verifica_analitica"]
