...
class CopiaDigitaleModel(BaseModel):
    ...
    CopiaDigitaleModel
    """ # noqa: E501
    num_iscr_sito: Annotated[str, Field(min_length=1, strict=True)]
    note: Optional[Annotated[str, Field(strict=True, max_length=500)]] = None
    xfir: Union[StrictBytes, StrictStr] = Field(description="Contenuto del file xFIR")
    __properties: ClassVar[List[str]] = ["num_iscr_sito", "note", "xfir"]
