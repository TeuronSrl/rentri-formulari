...
class DatiFirmaResult(BaseModel):
    ...
    __properties = ["denominazione_firmatario", "identificativo_firmatario", "data_firma", "identificativo_utente", "credentials_id", "nome_certificato_ca"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.nome_certificato_ca is None and "nome_certificato_ca" in self.__fields_set__:
