...
class DestinatarioItemResult(BaseModel):
    """
    Dati anagrafici riassuntivi riferiti ad un destinatario  # noqa: E501
    """
    ...
    __properties = ["attivita", "num_iscr_sito", "denominazione", "codice_fiscale", "indirizzo", "civico", "comune_id", "nazione_id", "citta_estera"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestinatarioItemResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DestinatarioItemResult:
        """Create an instance of DestinatarioItemResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DestinatarioItemResult.parse_obj(obj)

        _obj = DestinatarioItemResult.parse_obj({
