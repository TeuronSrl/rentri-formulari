...
class DatiTrasportatoreTrasmissioneModel(BaseModel):
    ...
    """ # noqa: E501
    trasportatore_id: StrictInt = Field(description="Id del trasportatore all'interno dei dati che vengono trasmessi")
    ...
    __properties: ClassVar[List[str]] = ["denominazione", "codice_fiscale", "nazione_id", "tipo_trasporto", "numero_iscrizione_albo"]
