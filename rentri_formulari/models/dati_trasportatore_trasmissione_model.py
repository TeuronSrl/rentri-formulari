...
class DatiTrasportatoreTrasmissioneModel(BaseModel):
    ...
    """
    trasportatore_id: StrictInt = Field(default=..., description="Id del trasportatore all'interno dei dati che vengono trasmessi")
    ...
    __properties = ["denominazione", "codice_fiscale", "nazione_id", "tipo_trasporto", "numero_iscrizione_albo"]
