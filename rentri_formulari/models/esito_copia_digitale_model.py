...
class EsitoCopiaDigitaleModel(BaseModel):
    ...
    transazione_id: Optional[UUID] = Field(default=None, description="Identificativo della transazione asincrona")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "esito": EsitoCaricaCopiaDigitaleModel.from_dict(obj["esito"]) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
