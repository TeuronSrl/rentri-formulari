...
class EsitoCopiaDigitaleModel(BaseModel):
    """
    EsitoCopiaDigitaleModel
    """
    esito: Optional[EsitoCaricaCopiaDigitaleModel] = Field(default=None, description="Esito")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoCopiaDigitaleModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoCopiaDigitaleModel:
        """Create an instance of EsitoCopiaDigitaleModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoCopiaDigitaleModel.parse_obj(obj)

        _obj = EsitoCopiaDigitaleModel.parse_obj({
            "esito": EsitoCaricaCopiaDigitaleModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
