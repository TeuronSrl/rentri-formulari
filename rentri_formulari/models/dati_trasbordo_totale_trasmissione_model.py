...
class DatiTrasbordoTotaleTrasmissioneModel(BaseModel):
    ...
    """ # noqa: E501
    id_trasportatore_trasbordo: StrictInt = Field(description="Id del trasportatore definito all'interno dei dati che vengono trasmessi a cui è riferito il trasbordo")
    trasportatore: DatiTrasportatoreTrasmissioneModel
    presa_in_carico: DatiTrasportoTrasmissioneBaseModel1
    __properties: ClassVar[List[str]] = ["id_trasportatore_trasbordo", "trasportatore", "presa_in_carico"]
