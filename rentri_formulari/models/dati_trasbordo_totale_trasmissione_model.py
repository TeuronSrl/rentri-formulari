...
class DatiTrasbordoTotaleTrasmissioneModel(BaseModel):
    ...
    """
    trasportatore_id: conint(strict=True, le=255, ge=1) = Field(default=..., description="Id del trasportatore definito all'interno dei dati che vengono trasmessi a cui è riferito il trasbordo")
    ...
    __properties = ["trasportatore_id", "id_trasportatore_trasbordo", "trasportatore", "presa_in_carico"]
    ...
    def to_dict(self):
        ...
        if self.id_trasportatore_trasbordo is None and "id_trasportatore_trasbordo" in self.__fields_set__:
