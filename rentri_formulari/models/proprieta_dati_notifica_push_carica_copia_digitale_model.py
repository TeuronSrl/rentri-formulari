...
class ProprietaDatiNotificaPushCaricaCopiaDigitaleModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identificativo", "numero_fir", "data_evento", "tipo_accettazione", "destinatario"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destinatario": IAnagrafica.from_dict(obj["destinatario"]) if obj.get("destinatario") is not None else None
        })
        return _obj
