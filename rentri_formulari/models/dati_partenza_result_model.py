...
class DatiPartenzaResultModel(BaseModel):
    ...
    trasportatori: Optional[List[DatiTrasportatoreFormularioResultModel]] = Field(default=None, description="Dati dei trasportatori")
    intermediari: Optional[List[DatiIntermediariFormularioModel]] = Field(default=None, description="Dati degli intermediari")
