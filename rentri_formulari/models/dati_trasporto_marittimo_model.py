...
class DatiTrasportoMarittimoModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiTrasportoMarittimoModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiTrasportoMarittimoModel:
        """Create an instance of DatiTrasportoMarittimoModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiTrasportoMarittimoModel.parse_obj(obj)
