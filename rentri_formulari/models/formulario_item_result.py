...
class FormularioItemResult(BaseModel):
    ...
    produttore: Optional[UnitaLocaleItemResult] = Field(default=None, description="Dati anagrafici del produttore/detentore indicato nel formulario")
    ...
    destinatari: Optional[List[UnitaLocaleItemResult]] = Field(default=None, description="Dati anagrafici dei destinatari indicati nel formulario")
