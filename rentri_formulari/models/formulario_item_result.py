...
class FormularioItemResult(BaseModel):
    ...
    destinatari: Optional[conlist(UnitaLocaleItemResult)] = None
    trasportatori: Optional[conlist(TrasportatoreItemResult)] = None
    intermediari: Optional[conlist(IntermediarioItemResult)] = None
    ...
    __properties = ["numero_fir", "data_emissione", "num_iscr_sito", "identificativo_soggetto", "data_creazione", "codice_eer", "quantita", "unita_misura", "stato_fisico", "caratteristiche_pericolo", "destinazione_rifiuto", "produttore", "trasbordo_parziale_origine", "destinatari", "trasportatori", "intermediari", "stato"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.destinazione_rifiuto is None and "destinazione_rifiuto" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> FormularioItemResult:
        ...
        _obj = FormularioItemResult.parse_obj({
            ...
            "produttore": UnitaLocaleItemResult.from_dict(obj.get("produttore")) if obj.get("produttore") is not None else None,
            ...
            "destinatari": [UnitaLocaleItemResult.from_dict(_item) for _item in obj.get("destinatari")] if obj.get("destinatari") is not None else None,
