...
class FormularioItemResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["numero_fir", "data_emissione", "num_iscr_sito", "identificativo_soggetto", "data_creazione", "codice_eer", "quantita", "unita_misura", "stato_fisico", "caratteristiche_pericolo", "descrizione_rifiuto", "produttore", "trasbordo_parziale_origine", "destinatari", "trasportatori", "intermediari", "accettazione", "stato", "is_upload", "versione"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accettazione": AccettazioneItemResult.from_dict(obj["accettazione"]) if obj.get("accettazione") is not None else None,
            "stato": obj.get("stato"),
