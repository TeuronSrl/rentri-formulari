...
class FormularioItemResult(BaseModel):
    ...
    __properties = ["numero_fir", "data_emissione", "num_iscr_sito", "identificativo_soggetto", "data_creazione", "codice_eer", "quantita", "unita_misura", "stato_fisico", "caratteristiche_pericolo", "descrizione_rifiuto", "produttore", "trasbordo_parziale_origine", "destinatari", "trasportatori", "intermediari", "stato", "is_upload", "versione"]
