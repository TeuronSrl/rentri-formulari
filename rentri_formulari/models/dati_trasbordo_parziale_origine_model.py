...
class DatiTrasbordoParzialeOrigineModel(BaseModel):
    ...
    """ # noqa: E501
    numero_fir_origine: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Numero FIR del formulario che ha subito il trasbordo parziale da cui prende origine il nuovo formulario")
    produttore_originario: DatiProduttoreOriginarioModel = Field(description="Dati del produttore del rifiuto originario come compariva nel formulario di origine")
    ...
    @field_validator('numero_fir_origine')
