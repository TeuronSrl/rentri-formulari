...
class DatiDestinatarioFormularioBaseModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiDestinatarioFormularioBaseModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiDestinatarioFormularioBaseModel:
