...
class EsitoValidazioneXfirModel(BaseModel):
    """
    EsitoValidazioneXfirModel
    """
    esito: Optional[EsitoValidaXfirModel] = Field(default=None, description="Esito")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoValidazioneXfirModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoValidazioneXfirModel:
        """Create an instance of EsitoValidazioneXfirModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoValidazioneXfirModel.parse_obj(obj)

        _obj = EsitoValidazioneXfirModel.parse_obj({
            "esito": EsitoValidaXfirModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
