...
class CopiaDigitaleResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identificativo", "numero_fir", "data_emissione", "num_iscr_sito", "produttore", "destinatari", "trasportatori", "intermediari", "note", "data_caricamento", "codice_fiscale_caricamento", "denominazione_caricamento", "emesso_da_identificativo", "emesso_da_denominazione", "accettazione"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accettazione": CopiaDigitaleAccettazioneResult.from_dict(obj["accettazione"]) if obj.get("accettazione") is not None else None
        })
        return _obj
