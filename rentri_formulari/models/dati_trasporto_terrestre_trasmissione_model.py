...
class DatiTrasportoTerrestreTrasmissioneModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data_ora_inizio_trasporto", "annotazioni", "trasportatore_id", "conducente", "targa_automezzo", "targa_rimorchio", "percorso", "presa_in_carico_rimorchio_precedente"]
