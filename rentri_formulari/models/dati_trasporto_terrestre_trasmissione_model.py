...
class DatiTrasportoTerrestreTrasmissioneModel(BaseModel):
    ...
    targa_automezzo: Optional[constr(strict=True, max_length=10)] = None
    targa_rimorchio: Optional[constr(strict=True, max_length=10)] = None
    percorso: Optional[constr(strict=True, max_length=1000)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiTrasportoTerrestreTrasmissioneModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiTrasportoTerrestreTrasmissioneModel:
