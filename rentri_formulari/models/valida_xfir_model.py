...
class ValidaXfirModel(BaseModel):
    """
    ValidaXfirModel
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidaXfirModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidaXfirModel:
        """Create an instance of ValidaXfirModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidaXfirModel.parse_obj(obj)

        _obj = ValidaXfirModel.parse_obj({
            "xfir": obj.get("xfir")
        })
        return _obj
