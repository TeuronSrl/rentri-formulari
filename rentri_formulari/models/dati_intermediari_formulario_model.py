...
class DatiIntermediariFormularioModel(BaseModel):
    """
    Dati intermediario  # noqa: E501
    """
    ...
    __properties = ["denominazione", "codice_fiscale", "nazione_id", "numero_iscrizione_albo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiIntermediariFormularioModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiIntermediariFormularioModel:
        """Create an instance of DatiIntermediariFormularioModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiIntermediariFormularioModel.parse_obj(obj)

        _obj = DatiIntermediariFormularioModel.parse_obj({
