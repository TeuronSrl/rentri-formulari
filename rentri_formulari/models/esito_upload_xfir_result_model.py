...
class EsitoUploadXfirResultModel(BaseModel):
    """
    EsitoUploadXfirResultModel
    """
    esito: Optional[EsitoUploadXfirModel] = Field(default=None, description="Esito")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoUploadXfirResultModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoUploadXfirResultModel:
        """Create an instance of EsitoUploadXfirResultModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoUploadXfirResultModel.parse_obj(obj)

        _obj = EsitoUploadXfirResultModel.parse_obj({
            "esito": EsitoUploadXfirModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
