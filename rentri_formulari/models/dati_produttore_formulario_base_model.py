...
class DatiProduttoreFormularioBaseModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiProduttoreFormularioBaseModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiProduttoreFormularioBaseModel:
