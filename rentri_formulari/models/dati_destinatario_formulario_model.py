...
class DatiDestinatarioFormularioModel(BaseModel):
    ...
    __properties = ["autorizzazione", "attivita", "numero_iscrizione_albo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiDestinatarioFormularioModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiDestinatarioFormularioModel:
        """Create an instance of DatiDestinatarioFormularioModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiDestinatarioFormularioModel.parse_obj(obj)

        _obj = DatiDestinatarioFormularioModel.parse_obj({
