...
class DatiTrasportoFerroviarioModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiTrasportoFerroviarioModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiTrasportoFerroviarioModel:
        """Create an instance of DatiTrasportoFerroviarioModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiTrasportoFerroviarioModel.parse_obj(obj)

        _obj = DatiTrasportoFerroviarioModel.parse_obj({
