...
class AzioniResult(BaseModel):
    ...
    azioni: Optional[List[Operazione]] = Field(default=None, description="Elenco delle operazioni effettuabili sul formulario abilitate per il soggetto specificato,  in funzione dello stato in cui si trova il formulario")
