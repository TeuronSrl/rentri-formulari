...
class AzioniResult(BaseModel):
    ...
    azioni: Optional[conlist(Operazione)] = Field(default=None, description="Elenco delle operazioni e specifici soggetti abilitati ad eseguirle effettuabili sul formulario in funzione dello stato in cui si trova")
