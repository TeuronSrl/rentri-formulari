...
class DatiDestinatarioTrasmissioneModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiDestinatarioTrasmissioneModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiDestinatarioTrasmissioneModel:
        """Create an instance of DatiDestinatarioTrasmissioneModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiDestinatarioTrasmissioneModel.parse_obj(obj)

        _obj = DatiDestinatarioTrasmissioneModel.parse_obj({
