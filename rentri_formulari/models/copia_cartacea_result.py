...
class CopiaCartaceaResult(BaseModel):
    ...
    __properties = ["identificativo", "numero_fir", "data_emissione", "num_iscr_sito", "produttore", "trasportatori", "intermediari", "note", "data_caricamento", "codice_fiscale_caricamento", "denominazione_caricamento", "emesso_da_identificativo", "emesso_da_denominazione"]
