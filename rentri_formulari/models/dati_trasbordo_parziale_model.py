...
class DatiTrasbordoParzialeModel(BaseModel):
    ...
    trasportatore: DatiTrasportatoreTrasbordoModel = Field(description="Trasportatore che prende in carico il rifiuto parzialmente trasbordato")
    ...
    __properties: ClassVar[List[str]] = ["numero_fir", "trasportatore", "quantita_residua", "causale"]
