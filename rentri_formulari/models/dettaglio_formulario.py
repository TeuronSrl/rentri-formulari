...
class DettaglioFormulario(BaseModel):
    ...
    dati_destinazioni_successive: Optional[List[DatiDestinazioniSuccessiveResultMdodel]] = Field(default=None, description="Dati relativi alle eventuali destinazioni successive inserite per il rifiuto a seguito di respingimenti")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dati_destinazioni_successive": [DatiDestinazioniSuccessiveResultMdodel.from_dict(_item) for _item in obj["dati_destinazioni_successive"]] if obj.get("dati_destinazioni_successive") is not None else None
        })
        return _obj
