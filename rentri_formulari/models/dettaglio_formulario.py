...
class DettaglioFormulario(BaseModel):
    ...
    dati_destinazioni_successive: Optional[conlist(DatiDestinazioniSuccessiveResultMdodel)] = Field(default=None, description="Dati relativi alle eventuali destinazioni successive inserite per il rifiuto a seguito di respingimenti")
