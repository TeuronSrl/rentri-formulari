...
class DettaglioFormulario(BaseModel):
    ...
    dati_trasporto: Optional[List[DettaglioFormularioDatiTrasportoInner]] = None
    dati_accettazione: Optional[DatiAccettazioneResultModel] = None
    dati_annotazioni: Optional[List[DatiAnnotazioneResultModel]] = None
    dati_allegati: Optional[List[DatiAllegatoResultModel]] = None
    ...
    dati_trasbordi_parziali: Optional[List[DatiTrasbordoParzialeResultModel]] = None
    dati_soste_tecniche: Optional[List[DatiSostaTecnicaResultModel]] = None
    dati_destinazioni_successive: Optional[List[DatiDestinazioniSuccessiveResultMdodel]] = None
