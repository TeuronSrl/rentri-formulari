...
class DettaglioFormulario(BaseModel):
    ...
    dati_trasporto: Optional[conlist(DettaglioFormularioDatiTrasportoInner)] = Field(default=None, description="Dati di trasporto per ciascun trasportatore indicato nei dati di partenza")
    ...
    dati_annotazioni: Optional[conlist(DatiAnnotazioneResultModel)] = Field(default=None, description="Dati relativi alle annotazioni aggiuntive")
    dati_allegati: Optional[conlist(DatiAllegatoResultModel)] = Field(default=None, description="Dati relativi agli allegati inseriti via API")
    ...
    dati_trasbordi_parziali: Optional[conlist(DatiTrasbordoParzialeResultModel)] = Field(default=None, description="Dati relativi agli eventuali trasbordi parziali del rifiuto")
    dati_soste_tecniche: Optional[conlist(DatiSostaTecnicaResultModel)] = Field(default=None, description="Dati relativi alle eventuali soste tecniche effettuate nel trasporto")
    dati_destinazioni_successive: Optional[conlist(DatiDestinazioniSuccessiveResultModel)] = Field(default=None, description="Dati relativi alle eventuali destinazioni successive inserite per il rifiuto a seguito di respingimenti")
    __properties = ["stato_formulario", "versione", "dati_vidimazione", "data_creazione", "provenienza_upload", "num_iscr_sito", "dati_partenza", "dati_trasporto", "dati_accettazione", "dati_annotazioni", "dati_allegati", "dati_annullamento", "dati_trasbordo_totale", "dati_trasbordi_parziali", "dati_soste_tecniche", "dati_destinazioni_successive"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.provenienza_upload is None and "provenienza_upload" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> DettaglioFormulario:
        ...
        _obj = DettaglioFormulario.parse_obj({
            ...
            "dati_destinazioni_successive": [DatiDestinazioniSuccessiveResultModel.from_dict(_item) for _item in obj.get("dati_destinazioni_successive")] if obj.get("dati_destinazioni_successive") is not None else None
        })
        return _obj
