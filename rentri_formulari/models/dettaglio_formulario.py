...
class DettaglioFormulario(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["stato_formulario", "versione", "dati_vidimazione", "num_iscr_sito", "dati_partenza", "dati_trasporto", "dati_accettazione", "dati_annotazioni", "dati_allegati", "dati_annullamento", "dati_trasbordo_totale", "dati_trasbordi_parziali", "dati_soste_tecniche", "dati_destinazioni_successive"]
