...
class DatiTrasportoTerrestreResultModel(BaseModel):
    ...
    targa_automezzo: Optional[constr(strict=True, max_length=10)] = Field(default=None, description="Targa automezzo.  Il dato è necessario se non si indica una targa per il rimorchio")
    targa_rimorchio: Optional[constr(strict=True, max_length=10)] = Field(default=None, description="Targa rimorchio")
    ...
    __properties = ["tipo_trasporto", "dati_firma_trasportatore", "trasportatore_id", "conducente", "targa_automezzo", "targa_rimorchio", "percorso", "presa_in_carico_rimorchio_precedente", "data_ora_inizio_trasporto", "annotazioni"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.presa_in_carico_rimorchio_precedente is None and "presa_in_carico_rimorchio_precedente" in self.__fields_set__:
