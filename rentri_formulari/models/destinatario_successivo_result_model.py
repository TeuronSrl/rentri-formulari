...
class DestinatarioSuccessivoResultModel(BaseModel):
    """
    ...
    __properties = ["denominazione", "codice_fiscale", "nazione_id", "indirizzo", "autorizzazione", "attivita", "numero_iscrizione_albo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestinatarioSuccessivoResultModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DestinatarioSuccessivoResultModel:
        """Create an instance of DestinatarioSuccessivoResultModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DestinatarioSuccessivoResultModel.parse_obj(obj)

        _obj = DestinatarioSuccessivoResultModel.parse_obj({
