...
class DatiRifiutoModel(BaseModel):
    ...
    descrizione: Optional[constr(strict=True, max_length=500)] = Field(default=None, description="Descrizione del rifiuto, richiesta se il Codice EER specificato è di tipo .99")
