...
class DatiDestinatarioSuccessivoResultModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["denominazione", "codice_fiscale", "nazione_id", "indirizzo", "id_destinatario", "dati_firma", "num_iscr_sito", "autorizzazione", "attivita", "numero_iscrizione_albo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.id_destinatario is None and "id_destinatario" in self.model_fields_set:
