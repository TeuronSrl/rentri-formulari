...
class DatiDestinatarioSuccessivoResultModel(BaseModel):
    """
    ...
    id_destinatario: Optional[StrictInt] = None
    dati_firma: Optional[DatiFirmaResult] = Field(default=None, description="Dati relativi alla firma per l'inserimento del nuovo destinatario")
    ...
    __properties = ["denominazione", "codice_fiscale", "nazione_id", "indirizzo", "id_destinatario", "dati_firma", "num_iscr_sito", "autorizzazione", "attivita", "numero_iscrizione_albo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiDestinatarioSuccessivoResultModel:
    ...
    def to_dict(self):
        ...
        # set to None if id_destinatario (nullable) is None
        # and __fields_set__ contains the field
        if self.id_destinatario is None and "id_destinatario" in self.__fields_set__:
            _dict['id_destinatario'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiDestinatarioSuccessivoResultModel:
        """Create an instance of DatiDestinatarioSuccessivoResultModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiDestinatarioSuccessivoResultModel.parse_obj(obj)

        _obj = DatiDestinatarioSuccessivoResultModel.parse_obj({
