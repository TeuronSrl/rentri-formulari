...
class DatiAnnullamentoModel(BaseModel):
    ...
    codice_fiscale_soggetto: Annotated[str, Field(min_length=5, strict=True, max_length=20)] = Field(description="Codice fiscale del soggetto.")
    __properties: ClassVar[List[str]] = ["note", "codice_fiscale_soggetto"]
