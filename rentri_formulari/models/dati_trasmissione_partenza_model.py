...
class DatiTrasmissionePartenzaModel(BaseModel):
    ...
    produttore: Optional[DatiProduttoreTrasmissioneModel] = None
    trasbordo_parziale_origine: Optional[DatiTrasbordoParzialeOrigineModel] = None
    destinatario: DatiDestinatarioTrasmissioneModel = Field(...)
    ...
    __properties = ["numero_fir", "produttore", "trasbordo_parziale_origine", "destinatario", "trasportatori", "data_emissione", "intermediari", "rifiuto", "annotazioni"]
