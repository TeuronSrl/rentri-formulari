...
class DatiTrasmissionePartenzaModel(BaseModel):
    ...
    destinatario: DatiDestinatarioTrasmissioneModel
    trasportatori: List[DatiTrasportatoreTrasmissioneModel]
    ...
    __properties: ClassVar[List[str]] = ["numero_fir", "produttore", "trasbordo_parziale_origine", "destinatario", "trasportatori", "data_emissione", "intermediari", "rifiuto", "annotazioni"]
