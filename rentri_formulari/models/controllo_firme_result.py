...
class ControlloFirmeResult(BaseModel):
    ...
    riferimenti: Optional[conlist(StrictStr)] = Field(default=None, description="Riferimenti ai file coperti dalla firma")
    ...
    __properties = ["data_firma", "riferimenti", "codice", "esito", "dettaglio", "nome_file"]
