...
class EsitoFormularioModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoFormularioModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoFormularioModel:
        """Create an instance of EsitoFormularioModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoFormularioModel.parse_obj(obj)

        _obj = EsitoFormularioModel.parse_obj({
