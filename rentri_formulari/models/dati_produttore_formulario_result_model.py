...
class DatiProduttoreFormularioResultModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["denominazione", "codice_fiscale", "nazione_id", "indirizzo", "num_iscr_sito", "luogo_produzione", "autorizzazione", "detentore", "numero_iscrizione_albo"]
