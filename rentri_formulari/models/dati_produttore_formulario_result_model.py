...
class DatiProduttoreFormularioResultModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiProduttoreFormularioResultModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiProduttoreFormularioResultModel:
        """Create an instance of DatiProduttoreFormularioResultModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiProduttoreFormularioResultModel.parse_obj(obj)

        _obj = DatiProduttoreFormularioResultModel.parse_obj({
