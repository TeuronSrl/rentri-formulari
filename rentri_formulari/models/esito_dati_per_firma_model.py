...
class EsitoDatiPerFirmaModel(BaseModel):
    """
    EsitoDatiPerFirmaModel
    """
    esito: Optional[EsitoGetHashPerFirmaModel] = Field(default=None, description="Esito")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoDatiPerFirmaModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoDatiPerFirmaModel:
        """Create an instance of EsitoDatiPerFirmaModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoDatiPerFirmaModel.parse_obj(obj)

        _obj = EsitoDatiPerFirmaModel.parse_obj({
            "esito": EsitoGetHashPerFirmaModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
