...
class DatiTrasbordoTotaleModel(BaseModel):
    ...
    """ # noqa: E501
    trasportatore: DatiPartenzaModelTrasportatoriInner
    presa_in_carico: DatiTrasportoTerrestreModel = Field(description="Dati del trasporto terrestre")
    __properties: ClassVar[List[str]] = ["trasportatore", "presa_in_carico"]
