...
class DatiTrasbordoTotaleModel(BaseModel):
    ...
    presa_in_carico: DatiTrasportoTerrestreModel1
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "presa_in_carico": DatiTrasportoTerrestreModel1.from_dict(obj["presa_in_carico"]) if obj.get("presa_in_carico") is not None else None
        })
        return _obj
