...
class DatiTrasbordoTotaleModel(BaseModel):
    ...
    presa_in_carico: DatiTrasportoTerrestreModel1 = Field(...)
    ...
    def from_dict(cls, obj: dict) -> DatiTrasbordoTotaleModel:
        ...
        _obj = DatiTrasbordoTotaleModel.parse_obj({
            ...
            "presa_in_carico": DatiTrasportoTerrestreModel1.from_dict(obj.get("presa_in_carico")) if obj.get("presa_in_carico") is not None else None
        })
        return _obj
