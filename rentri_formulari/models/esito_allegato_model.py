...
class EsitoAllegatoModel(BaseModel):
    """
    EsitoAllegatoModel
    """
    esito: Optional[EsitoAddAllegatoModel] = Field(default=None, description="Esito")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoAllegatoModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoAllegatoModel:
        """Create an instance of EsitoAllegatoModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoAllegatoModel.parse_obj(obj)

        _obj = EsitoAllegatoModel.parse_obj({
            "esito": EsitoAddAllegatoModel.from_dict(obj.get("esito")) if obj.get("esito") is not None else None,
            "tipo": obj.get("tipo"),
