...
class FormularioDigitaleApi:
    ...
    def count_get(
        self,
        num_iscr_sito: Annotated[Optional[StrictStr], Field(description="Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"identificativo_soggetto\".")] = None,
        identificativo_soggetto: Annotated[Optional[StrictStr], Field(description="Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"num_iscr_sito\".")] = None,
        solo_senza_visibilita_siti: Annotated[Optional[StrictBool], Field(description="Se valorizzata a true, quando viene valorizzata la proprietà \"identificativo_soggetto\" esclude dalla lista restituita  i FIR per cui esiste già visibilità per almeno un'unità locale riconducibile al soggetto stesso.")] = None,
        numero_fir: Annotated[Optional[StrictStr], Field(description="Numero del FIR")] = None,
        codice_blocco: Annotated[Optional[StrictStr], Field(description="Codice blocco del FIR")] = None,
        ...
        _param = self._count_get_serialize(
            ...
            solo_senza_visibilita_siti=solo_senza_visibilita_siti,
    ...
    def _count_get_serialize(
        ...
        if solo_senza_visibilita_siti is not None:
            
            _query_params.append(('solo_senza_visibilita_siti', solo_senza_visibilita_siti))
    ...
    def numero_fir_allegato_allegato_id_delete(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        allegato_id: Annotated[StrictInt, Field(description="Identificativo dell'allegato all'interno del FIR digitale")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._numero_fir_allegato_allegato_id_delete_serialize(
            numero_fir=numero_fir,
    ...
    @validate_call
    def numero_fir_allegato_allegato_id_delete_with_http_info(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        allegato_id: Annotated[StrictInt, Field(description="Identificativo dell'allegato all'interno del FIR digitale")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
    ...
    @validate_call
    def numero_fir_allegato_allegato_id_delete_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        allegato_id: Annotated[StrictInt, Field(description="Identificativo dell'allegato all'interno del FIR digitale")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
    ...
    def _numero_fir_allegato_allegato_id_delete_serialize(
        self,
        numero_fir,
        allegato_id,
        x_reply_to,
        ...
        if numero_fir is not None:
            _path_params['numero_fir'] = numero_fir
        if allegato_id is not None:
            _path_params['allegato_id'] = allegato_id
        # process the query parameters
        # process the header parameters
        if x_reply_to is not None:
            _header_params['X-ReplyTo'] = x_reply_to
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/{numero_fir}/allegato/{allegato_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def numero_fir_allegato_allegato_id_get(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        allegato_id: Annotated[StrictInt, Field(description="Identificativo dell'allegato all'interno del FIR digitale")],
        _request_timeout: Union[
        ...
        _param = self._numero_fir_allegato_allegato_id_get_serialize(
            numero_fir=numero_fir,
            allegato_id=allegato_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def numero_fir_allegato_allegato_id_get_with_http_info(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        allegato_id: Annotated[StrictInt, Field(description="Identificativo dell'allegato all'interno del FIR digitale")],
        _request_timeout: Union[
    ...
    @validate_call
    def numero_fir_allegato_allegato_id_get_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        allegato_id: Annotated[StrictInt, Field(description="Identificativo dell'allegato all'interno del FIR digitale")],
        _request_timeout: Union[
    ...
    def _numero_fir_allegato_allegato_id_get_serialize(
        self,
        numero_fir,
        allegato_id,
        _request_auth,
    ...
    @validate_call
    def numero_fir_annulla_fir_post(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
        ...
        _param = self._numero_fir_annulla_fir_post_serialize(
            numero_fir=numero_fir,
            x_reply_to=x_reply_to,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def numero_fir_annulla_fir_post_with_http_info(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def numero_fir_annulla_fir_post_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
    ...
    def _numero_fir_annulla_fir_post_serialize(
        self,
        numero_fir,
        x_reply_to,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{numero_fir}/annulla-fir',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def numero_fir_annulla_post(
        ...
        """(Deprecated) 🔁[ASYNC] ⚠️[DEPRECATO] - utilizzare /{numeroFIR}/annulla-fir - Annullamento FIR
    ...
    def numero_fir_azioni_get(
        ...
        num_iscr_sito: Annotated[Optional[StrictStr], Field(description="Se valorizzato con il numero di iscrizione di una unità locale del soggetto specificato con il parametro <b>identificativo_soggetto</b>, l'unità locale acquisisce automaticamente la visibilità per il FIR digitale")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def numero_fir_invia_a_dispositivo_post(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        ...
        _param = self._numero_fir_invia_a_dispositivo_post_serialize(
            numero_fir=numero_fir,
    ...
    @validate_call
    def numero_fir_invia_a_dispositivo_post_with_http_info(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        credentials_id: Annotated[StrictStr, Field(description="Identificativo delle credenziali")],
        _request_timeout: Union[
    ...
    @validate_call
    def numero_fir_invia_a_dispositivo_post_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        credentials_id: Annotated[StrictStr, Field(description="Identificativo delle credenziali")],
        _request_timeout: Union[
    ...
    def _numero_fir_invia_a_dispositivo_post_serialize(
        self,
        numero_fir,
        credentials_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{numero_fir}/invia-a-dispositivo',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def numero_fir_note_annullamento_post(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        note_annullamento_model: Annotated[NoteAnnullamentoModel, Field(description="Dati di annullamento")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._numero_fir_note_annullamento_post_serialize(
            numero_fir=numero_fir,
            note_annullamento_model=note_annullamento_model,
            x_reply_to=x_reply_to,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def numero_fir_note_annullamento_post_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        note_annullamento_model: Annotated[NoteAnnullamentoModel, Field(description="Dati di annullamento")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
    ...
    def _numero_fir_note_annullamento_post_serialize(
        self,
        numero_fir,
        ...
        # process the form parameters
        # process the body parameter
        if note_annullamento_model is not None:
            _body_params = note_annullamento_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{numero_fir}/note-annullamento',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def numero_fir_rollback_firma_post(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
        ...
        _param = self._numero_fir_rollback_firma_post_serialize(
            numero_fir=numero_fir,
            x_reply_to=x_reply_to,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def numero_fir_rollback_firma_post_with_http_info(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def numero_fir_rollback_firma_post_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
    ...
    def _numero_fir_rollback_firma_post_serialize(
        self,
        numero_fir,
        x_reply_to,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{numero_fir}/rollback-firma',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def numero_fir_trasbordo_parziale_post(
        ...
        dati_trasbordo_parziale_model: Annotated[DatiTrasbordoParzialeModel, Field(description="Dati con il dettaglio del trasbordo parziale")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def numero_fir_trasbordo_totale_post(
        ...
        dati_trasbordo_totale_model: Annotated[DatiTrasbordoTotaleModel, Field(description="Dati con il dettaglio del trasbordo totale")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def numero_fir_xfir_post(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario, deve coincidere con quello deducibile dalle informazioni presenti nel file xFIR")],
        upload_xfir_model: Annotated[UploadXfirModel, Field(description="Oggetto contenente il contenuto del file xFIR da caricare")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._numero_fir_xfir_post_serialize(
            numero_fir=numero_fir,
            upload_xfir_model=upload_xfir_model,
            x_reply_to=x_reply_to,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def numero_fir_xfir_post_with_http_info(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario, deve coincidere con quello deducibile dalle informazioni presenti nel file xFIR")],
        upload_xfir_model: Annotated[UploadXfirModel, Field(description="Oggetto contenente il contenuto del file xFIR da caricare")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
    ...
    @validate_call
    def numero_fir_xfir_post_without_preload_content(
        self,
        numero_fir: Annotated[str, Field(strict=True, description="Numero FIR del formulario, deve coincidere con quello deducibile dalle informazioni presenti nel file xFIR")],
        upload_xfir_model: Annotated[UploadXfirModel, Field(description="Oggetto contenente il contenuto del file xFIR da caricare")],
        x_reply_to: Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None,
    ...
    def _numero_fir_xfir_post_serialize(
        self,
        numero_fir,
        upload_xfir_model,
        x_reply_to,
        ...
        # process the form parameters
        # process the body parameter
        if upload_xfir_model is not None:
            _body_params = upload_xfir_model
