...
class FormularioDigitaleApi:
    ...
    @validate_arguments
    def count_get(self, num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"identificativo_soggetto\".")] = None, identificativo_soggetto : Annotated[Optional[StrictStr], Field(description="Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"num_iscr_sito\".")] = None, solo_senza_visibilita_siti : Annotated[Optional[StrictBool], Field(description="Se valorizzata a true, quando viene valorizzata la proprietà \"identificativo_soggetto\" esclude dalla lista restituita  i FIR per cui esiste già visibilità per almeno un'unità locale riconducibile al soggetto stesso.")] = None, numero_fir : Annotated[Optional[StrictStr], Field(description="Numero del FIR")] = None, codice_blocco : Annotated[Optional[StrictStr], Field(description="Codice blocco del FIR")] = None, data_creazione_da : Annotated[Optional[datetime], Field(description="Data di creazione a partire dalla quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_creazione_a : Annotated[Optional[datetime], Field(description="Data massima di creazione per la quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, codice_eer : Annotated[Optional[constr(strict=True, max_length=8)], Field(description="Codice EER")] = None, stati : Optional[conlist(StrictStr)] = None, **kwargs) -> int:  # noqa: E501
        ...
        :param num_iscr_sito: Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"identificativo_soggetto\".
        :type num_iscr_sito: str
        :param identificativo_soggetto: Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"num_iscr_sito\".
        :type identificativo_soggetto: str
        :param solo_senza_visibilita_siti: Se valorizzata a true, quando viene valorizzata la proprietà \"identificativo_soggetto\" esclude dalla lista restituita  i FIR per cui esiste già visibilità per almeno un'unità locale riconducibile al soggetto stesso.
    ...
    @validate_arguments
    def count_get_with_http_info(self, num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"identificativo_soggetto\".")] = None, identificativo_soggetto : Annotated[Optional[StrictStr], Field(description="Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"num_iscr_sito\".")] = None, solo_senza_visibilita_siti : Annotated[Optional[StrictBool], Field(description="Se valorizzata a true, quando viene valorizzata la proprietà \"identificativo_soggetto\" esclude dalla lista restituita  i FIR per cui esiste già visibilità per almeno un'unità locale riconducibile al soggetto stesso.")] = None, numero_fir : Annotated[Optional[StrictStr], Field(description="Numero del FIR")] = None, codice_blocco : Annotated[Optional[StrictStr], Field(description="Codice blocco del FIR")] = None, data_creazione_da : Annotated[Optional[datetime], Field(description="Data di creazione a partire dalla quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_creazione_a : Annotated[Optional[datetime], Field(description="Data massima di creazione per la quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, codice_eer : Annotated[Optional[constr(strict=True, max_length=8)], Field(description="Codice EER")] = None, stati : Optional[conlist(StrictStr)] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Conteggio formulari  # noqa: E501
    ...
    @validate_arguments
    def numero_fir_allegato_allegato_id_delete(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], allegato_id : Annotated[StrictInt, Field(..., description="Identificativo dell'allegato all'interno del FIR digitale")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> TransazioneModel:  # noqa: E501
    ...
    def numero_fir_allegato_allegato_id_get(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], allegato_id : Annotated[StrictInt, Field(..., description="Identificativo dell'allegato all'interno del FIR digitale")], **kwargs) -> DownloadableBaseResponse:  # noqa: E501
        ...
        Restituisce il file allegato al formulario digitale specificato.  L'operazione può essere eseguita da un'utenza che abbia incarichi per (o coincida con) il soggetto a cui è stato riferito l'allegato specificato in fase di inserimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def numero_fir_annulla_fir_post(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> TransazioneModel:  # noqa: E501
    ...
    @validate_arguments
    def numero_fir_annulla_fir_post_with_http_info(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """🔁[ASYNC] Annullamento FIR  # noqa: E501
    ...
    def numero_fir_annulla_post(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], dati_annullamento_model : Annotated[DatiAnnullamentoModel, Field(..., description="Insieme delle informazioni riguardanti l'allegato da aggiungere al formulario")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> TransazioneModel:  # noqa: E501
        """(Deprecated) 🔁[ASYNC] ⚠️[DEPRECATO] - utilizzare /{numeroFIR}/annulla-fir - Annullamento FIR  # noqa: E501
    ...
    @validate_arguments
    def numero_fir_azioni_get(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per il quale si richiedono le azioni possibili")], num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Se valorizzato con il numero di iscrizione di una unità locale del soggetto specificato con il parametro <b>identificativo_soggetto</b>, l'unità locale acquisisce automaticamente la visibilità per il FIR digitale")] = None, **kwargs) -> AzioniResult:  # noqa: E501
        ...
        :type identificativo_soggetto: str
        :param num_iscr_sito: Se valorizzato con il numero di iscrizione di una unità locale del soggetto specificato con il parametro <b>identificativo_soggetto</b>, l'unità locale acquisisce automaticamente la visibilità per il FIR digitale
        :type num_iscr_sito: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
    ...
    def numero_fir_invia_a_dispositivo_post(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], credentials_id : Annotated[StrictStr, Field(..., description="Identificativo delle credenziali")], **kwargs) -> None:  # noqa: E501
        ...
        Effettua l'invio delle informazioni di un formulario al dispositivo associato all'identificativo delle credenziali.  L'operazione può essere eseguita da un'utenza che abbia incarichi per (o coincida con) almeno uno dei soggetti coinvolti nel formulario.  Le credenziali indicate nel parametro <b>credentials_id</b> devono essere state create attraverso le API \"Firma remota RENTRI\",  e devono essere associate o all'unità locale che ha creato il FIR digitale, oppure ad una delle unità locali che abbiano già acquisito la visibilità del FIR digitale.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def numero_fir_pdf_get(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], **kwargs) -> DownloadableBaseResponse:  # noqa: E501
        ...
        Ottiene una stampa in PDF del FIR.  L'operazione può essere eseguita da un'utenza che abbia incarichi per (o coincida con) almeno uno dei soggetti coinvolti nel formulario.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def numero_fir_respingi_post(self, numero_fir : constr(strict=True), num_iscr_sito : Optional[constr(strict=True)] = None, **kwargs) -> None:  # noqa: E501
        ...
        Abbandona la visibilità in ricerca sull'unità locale specificata, ottenuta con l'operazione di \"acquisizione di visibilità\", relativamente al FIR digitale specificato creato da terzi.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def numero_fir_rollback_firma_post(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> TransazioneModel:  # noqa: E501
    ...
    @validate_arguments
    def numero_fir_rollback_firma_post_with_http_info(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """🔁[ASYNC] Rollback dell'ultima firma  # noqa: E501
    ...
    @validate_arguments
    def numero_fir_trasbordo_totale_post(self, numero_fir : Annotated[constr(strict=True), Field(..., description="Numero FIR del formulario a cui si aggiungono i dati del trasbordo totale")], dati_trasbordo_totale_model : Annotated[DatiTrasbordoTotaleModel, Field(..., description="Dati con il dettaglio del trasbordo totale")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> TransazioneModel:  # noqa: E501
    ...
    @validate_arguments
    def root_get_with_http_info(self, num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"identificativo_soggetto\".")] = None, identificativo_soggetto : Annotated[Optional[StrictStr], Field(description="Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per la proprietà \"num_iscr_sito\".")] = None, solo_senza_visibilita_siti : Annotated[Optional[StrictBool], Field(description="Se valorizzata a true, quando viene valorizzata la proprietà \"identificativo_soggetto\" esclude dalla lista restituita  i FIR per cui esiste già visibilità per almeno un'unità locale riconducibile al soggetto stesso.")] = None, numero_fir : Annotated[Optional[StrictStr], Field(description="Numero del FIR")] = None, codice_blocco : Annotated[Optional[StrictStr], Field(description="Codice blocco del FIR")] = None, data_creazione_da : Annotated[Optional[datetime], Field(description="Data di creazione a partire dalla quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_creazione_a : Annotated[Optional[datetime], Field(description="Data massima di creazione per la quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono i formulari (formato ISO 8601 UTC)")] = None, codice_eer : Annotated[Optional[constr(strict=True, max_length=8)], Field(description="Codice EER")] = None, stati : Optional[conlist(StrictStr)] = None, paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page.")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Elenco formulari  # noqa: E501
