...
class FormularioDigitaleApi:
    ...
    def count_get(
        self,
        num_iscr_sito: Annotated[Optional[StrictStr], Field(description="Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per il campo \"identificativo_soggetto\".")] = None,
        identificativo_soggetto: Annotated[Optional[StrictStr], Field(description="Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per il campo \"num_iscr_sito\".")] = None,
        ...
        :param num_iscr_sito: Numero iscrizione unità locale rilasciato all'iscrizione per il quale si richiedono i formulari. Il dato deve essere valorizzato in assenza di un valore per il campo \"identificativo_soggetto\".
        :type num_iscr_sito: str
        :param identificativo_soggetto: Identificativo del soggetto. Quando viene specificato vengono restituiti tutti i FIR digitali nei quali il valore specificato  coincide con il codice fiscale di uno dei soggetti indicati, indipendentemente dallo specifico ruolo  e indipendentemente dall'aver acquisito la visibilità del FIR digitale in una specifica Unità Locale. Il dato deve essere valorizzato in assenza di un valore per il campo \"num_iscr_sito\".
