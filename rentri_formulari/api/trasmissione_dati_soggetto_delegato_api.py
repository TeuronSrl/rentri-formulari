...
class TrasmissioneDatiSoggettoDelegatoApi:
    ...
    def trasmissioni_soggetto_delegato_num_iscr_sito_get(
        ...
        _param = self._trasmissioni_soggetto_delegato_num_iscr_sito_get_serialize(
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_get_without_preload_content(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True, description="Numero iscrizione dell'unità locale per cui si vogliono recuperare le trasmissioni")],
        numero_fir: Annotated[Optional[StrictStr], Field(description="Numero del FIR oggetto della trasmissione")] = None,
        data_trasmissione_da: Annotated[Optional[datetime], Field(description="Formato ISO 8601 UTC")] = None,
    ...
    def _trasmissioni_soggetto_delegato_num_iscr_sito_get_serialize(
        self,
        num_iscr_sito,
        numero_fir,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/trasmissioni/soggetto-delegato/{num_iscr_sito}',
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_annulla_delete(
        self,
        ...
        _param = self._trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_annulla_delete_serialize(
            num_iscr_sito=num_iscr_sito,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_annulla_delete_with_http_info(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True)],
        identificativo: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_annulla_delete_without_preload_content(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True)],
        identificativo: StrictStr,
        _request_timeout: Union[
    ...
    def _trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_annulla_delete_serialize(
        self,
        num_iscr_sito,
        identificativo,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/trasmissioni/soggetto-delegato/{num_iscr_sito}/{identificativo}/annulla',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_get(
        ...
        _param = self._trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_get_serialize(
            num_iscr_sito=num_iscr_sito,
            identificativo=identificativo,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_get_without_preload_content(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True, description="Numero iscrizione dell'unità locale per cui si vogliono recuperare le trasmissioni")],
        identificativo: Annotated[StrictStr, Field(description="Identificativo della trasmissione")],
        _request_timeout: Union[
    ...
    def _trasmissioni_soggetto_delegato_num_iscr_sito_identificativo_get_serialize(
        self,
        num_iscr_sito,
        identificativo,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/trasmissioni/soggetto-delegato/{num_iscr_sito}/{identificativo}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_numero_fir_estrai_post(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True)],
        ...
        _param = self._trasmissioni_soggetto_delegato_num_iscr_sito_numero_fir_estrai_post_serialize(
            num_iscr_sito=num_iscr_sito,
            numero_fir=numero_fir,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_numero_fir_estrai_post_with_http_info(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True)],
        numero_fir: Annotated[str, Field(strict=True)],
        estrai_dati_xfir_model: EstraiDatiXfirModel,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_numero_fir_estrai_post_without_preload_content(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True)],
        numero_fir: Annotated[str, Field(strict=True)],
        estrai_dati_xfir_model: EstraiDatiXfirModel,
    ...
    def _trasmissioni_soggetto_delegato_num_iscr_sito_numero_fir_estrai_post_serialize(
        self,
        num_iscr_sito,
        numero_fir,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/trasmissioni/soggetto-delegato/{num_iscr_sito}/{numero_fir}/estrai',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_post(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True, description="Numero di iscrizione dell'unità locale alla quale è riferita la trasmissione dei dati del FIR digitale")],
        ...
        num_iscr_sito_trasportatore: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Eventuale numero di iscrizione dell'unità locale del trasportatore che effettua la trasmissione per conto del produttore")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._trasmissioni_soggetto_delegato_num_iscr_sito_post_serialize(
            num_iscr_sito=num_iscr_sito,
            dati_trasmissione_formulario_model=dati_trasmissione_formulario_model,
            num_iscr_sito_trasportatore=num_iscr_sito_trasportatore,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_post_with_http_info(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True, description="Numero di iscrizione dell'unità locale alla quale è riferita la trasmissione dei dati del FIR digitale")],
        dati_trasmissione_formulario_model: Annotated[DatiTrasmissioneFormularioModel, Field(description="Dati del FIR digitale trasmessi")],
        num_iscr_sito_trasportatore: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Eventuale numero di iscrizione dell'unità locale del trasportatore che effettua la trasmissione per conto del produttore")] = None,
    ...
    @validate_call
    def trasmissioni_soggetto_delegato_num_iscr_sito_post_without_preload_content(
        self,
        num_iscr_sito: Annotated[str, Field(strict=True, description="Numero di iscrizione dell'unità locale alla quale è riferita la trasmissione dei dati del FIR digitale")],
        dati_trasmissione_formulario_model: Annotated[DatiTrasmissioneFormularioModel, Field(description="Dati del FIR digitale trasmessi")],
        num_iscr_sito_trasportatore: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Eventuale numero di iscrizione dell'unità locale del trasportatore che effettua la trasmissione per conto del produttore")] = None,
    ...
    def _trasmissioni_soggetto_delegato_num_iscr_sito_post_serialize(
        self,
        num_iscr_sito,
        ...
        if num_iscr_sito is not None:
            _path_params['num_iscr_sito'] = num_iscr_sito
        # process the query parameters
        if num_iscr_sito_trasportatore is not None:
            
            _query_params.append(('num_iscr_sito_trasportatore', num_iscr_sito_trasportatore))
