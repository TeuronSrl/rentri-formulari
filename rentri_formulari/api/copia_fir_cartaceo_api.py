...
class CopiaFIRCartaceoApi:
    ...
    def copia_cartacea_transazione_id_result_get(
        self,
        transazione_id: Annotated[UUID, Field(description="Id della richiesta")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
