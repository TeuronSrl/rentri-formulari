...
class CopiaFIRCartaceoApi:
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_get_with_http_info(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato le copie dei FIR cartacei             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize")] = None, numero_fir : Annotated[Optional[StrictStr], Field(description="Pattern per filtrare i numeri delle copie dei FIR cartacei da restituire")] = None, confermate : Annotated[Optional[StrictBool], Field(description="Opzione per filtrare solo le copie dei FIR cartacei confermate o solo quelle non confermate, non specificare il valore per averle tutte")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Elenco copie FIR cartaceo caricate  # noqa: E501
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_identificativo_delete(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato la copia del FIR cartaceo.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo da cancellare")], **kwargs) -> None:  # noqa: E501
        """Cancella copia FIR cartaceo  # noqa: E501

        Elimina il caricamento della copia del FIR cartaceo. L'operazione è possibile solo se nessuno dei soggetti a cui è stata resa disponibile la copia del FIR cartaceo l'ha già presa in carico con l'operazione di conferma.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_identificativo_delete_with_http_info(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato la copia del FIR cartaceo.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo da cancellare")], **kwargs) -> ApiResponse:  # noqa: E501
        """Cancella copia FIR cartaceo  # noqa: E501
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_identificativo_documento_get(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato la copia del FIR cartaceo.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo della quale restituire il documento caricato")], **kwargs) -> DownloadableBaseResponse:  # noqa: E501
        """Documento copia FIR cartaceo  # noqa: E501

        Restituisce il file contenente la copia del FIR cartaceo caricata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_identificativo_documento_get_with_http_info(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato la copia del FIR cartaceo.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo della quale restituire il documento caricato")], **kwargs) -> ApiResponse:  # noqa: E501
        """Documento copia FIR cartaceo  # noqa: E501
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_identificativo_get(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato la copia del FIR cartaceo             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo")], **kwargs) -> CopiaCartaceaResult:  # noqa: E501
        """Dettaglio copia FIR cartaceo  # noqa: E501

        Recupera le informazioni di dettaglio del caricamento della copia del FIR cartaceo specificata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_identificativo_get_with_http_info(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che ha caricato la copia del FIR cartaceo             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo")], **kwargs) -> ApiResponse:  # noqa: E501
        """Dettaglio copia FIR cartaceo  # noqa: E501
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_post(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che carica la copia del FIR cartaceo. Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], copia_cartacea_model : Annotated[CopiaCartaceaModel, Field(..., description="Dati relativi alla copia del FIR cartaceo e ai soggetti a cui la si rende disponibile")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback opzionale alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> TransazioneModel:  # noqa: E501
        """🔁[ASYNC] Carica copia FIR cartaceo  # noqa: E501

        Acquisisce la richiesta di restituzione della copia del FIR cartaceo che consente al Trasportatore di renderla disponibile ai soggetti specificati.  Con l'identificativo della transazione restituito è possibile consultare lo stato di avanzamento dell'elaborazione e richiederne l'esito.   Il file caricato deve essere in uno dei seguenti formati: PDF, JPG, PNG.  Il file non deve superare la dimensione di 5 MB. <br/>Se viene specificato un URL nell'header <i>X-ReplyTo</i>, al termine dell'elaborazione dei dati, il fruitore riceverà una notifica con l'esito dell'elaborazione all'URL specificato.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def copia_cartacea_caricamento_num_iscr_sito_post_with_http_info(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del trasportatore che carica la copia del FIR cartaceo. Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], copia_cartacea_model : Annotated[CopiaCartaceaModel, Field(..., description="Dati relativi alla copia del FIR cartaceo e ai soggetti a cui la si rende disponibile")], x_reply_to : Annotated[Optional[StrictStr], Field(description="URL di callback opzionale alla quale verrà inviata la notifica di fine elaborazione")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """🔁[ASYNC] Carica copia FIR cartaceo  # noqa: E501
    ...
    @validate_arguments
    def copia_cartacea_conferma_identificativo_soggetto_get(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per cui richiedere l'elenco delle copie dei FIR cartacei disponibili")], numero_fir : Annotated[Optional[StrictStr], Field(description="Numero FIR della copia del FIR cartaceo")] = None, confermate : Annotated[Optional[StrictBool], Field(description="Filtra le copie dei FIR digitali confermate o non confermate.")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Eventuale numero di iscrizione dell'unità locale per la quale si richiedeono le copie cartacee dei FIR. Se non indicato ma si richiedono le sole copie cartacee confermate, verranno restituite solo le copie cartacee che sono state confermate senza essere associate ad alcuna unità locale")] = None, ruolo : Annotated[Optional[Any], Field(description="Specifica il ruolo per cui si richiedono le copie cartacee dei FIR.  Se non indicato ma si indica una unità locale, vengono considerati tutti i ruoli associati all'unità locale specificata.")] = None, paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize")] = None, **kwargs) -> List[CopiaCartaceaResult]:  # noqa: E501
        """Copie FIR cartacei disponibili  # noqa: E501

        Ottiene la lista delle copie dei FIR cartacei, disponibili per la conferma o già confermati, per il soggetto specificato.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.copia_cartacea_conferma_identificativo_soggetto_get(identificativo_soggetto, numero_fir, confermate, data_emissione_da, data_emissione_a, num_iscr_sito, ruolo, paging_page, paging_page_size, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.copia_cartacea_conferma_identificativo_soggetto_get_with_http_info(identificativo_soggetto, numero_fir, confermate, data_emissione_da, data_emissione_a, num_iscr_sito, ruolo, paging_page, paging_page_size, **kwargs)  # noqa: E501
    ...
    def copia_cartacea_conferma_identificativo_soggetto_get_with_http_info(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per cui richiedere l'elenco delle copie dei FIR cartacei disponibili")], numero_fir : Annotated[Optional[StrictStr], Field(description="Numero FIR della copia del FIR cartaceo")] = None, confermate : Annotated[Optional[StrictBool], Field(description="Filtra le copie dei FIR digitali confermate o non confermate.")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Eventuale numero di iscrizione dell'unità locale per la quale si richiedeono le copie cartacee dei FIR. Se non indicato ma si richiedono le sole copie cartacee confermate, verranno restituite solo le copie cartacee che sono state confermate senza essere associate ad alcuna unità locale")] = None, ruolo : Annotated[Optional[Any], Field(description="Specifica il ruolo per cui si richiedono le copie cartacee dei FIR.  Se non indicato ma si indica una unità locale, vengono considerati tutti i ruoli associati all'unità locale specificata.")] = None, paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.copia_cartacea_conferma_identificativo_soggetto_get_with_http_info(identificativo_soggetto, numero_fir, confermate, data_emissione_da, data_emissione_a, num_iscr_sito, ruolo, paging_page, paging_page_size, async_req=True)
        >>> result = thread.get()
    ...
    def copia_cartacea_conferma_identificativo_soggetto_identificativo_documento_get(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per il quale si richiede il documento della copia del FIR cartaceo")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo caricata dal trasportatore")], **kwargs) -> DownloadableBaseResponse:  # noqa: E501
        ...
        Restituisce il documento della copia del FIR cartaceo specificata caricata dal trasportatore.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_cartacea_conferma_identificativo_soggetto_identificativo_get(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto a cui è resa disponibile la copia del FIR cartaceo")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR cartaceo per cui vengono richieste le informazioni di dettaglio")], **kwargs) -> CopiaCartaceaResult:  # noqa: E501
        ...
        Restituisce il dettaglio dei dati di caricamento della copia del FIR cartaceo caricata dal trasportatore.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_cartacea_conferma_identificativo_soggetto_put(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per il quale si conferma la copia del FIR cartaceo")], copia_cartacea_conferma_model : Annotated[CopiaCartaceaConfermaModel, Field(..., description="Struttura dati contenente l'identificativo della copia del FIR cartaceo e l'eventuale identificativo dell'unità locale a cui associare la conferma")], **kwargs) -> None:  # noqa: E501
        ...
        Pone in stato \"confermata\" la copia del FIR cartaceo specificata associandola all'unità locale specificata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_cartacea_transazione_id_status_get(self, transazione_id : Annotated[StrictStr, Field(..., description="Id della richiesta")], **kwargs) -> None:  # noqa: E501
        ...
        Ottiene lo stato di elaborazione di una richiesta di vidimazione FIR.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
