...
class CopiaFIRCartaceoApi:
    ...
    def copia_cartacea_conferma_identificativo_soggetto_get(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per cui richiedere l'elenco delle copie dei FIR cartacei disponibili")], numero_fir : Annotated[Optional[StrictStr], Field(description="Numero FIR della copia del FIR cartaceo")] = None, confermate : Annotated[Optional[StrictBool], Field(description="Filtra le copie dei FIR digitali confermate o non confermate.")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Eventuale numero di iscrizione dell'unità locale per la quale si richiedono le copie cartacee dei FIR. Se non indicato ma si richiedono le sole copie cartacee confermate, verranno restituite solo le copie cartacee che sono state confermate senza essere associate ad alcuna unità locale")] = None, ruolo : Annotated[Optional[Any], Field(description="Specifica il ruolo per cui si richiedono le copie cartacee dei FIR.  Se non indicato ma si indica una unità locale, vengono considerati tutti i ruoli associati all'unità locale specificata.")] = None, paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize")] = None, **kwargs) -> List[CopiaCartaceaResult]:  # noqa: E501
        ...
        :param num_iscr_sito: Eventuale numero di iscrizione dell'unità locale per la quale si richiedono le copie cartacee dei FIR. Se non indicato ma si richiedono le sole copie cartacee confermate, verranno restituite solo le copie cartacee che sono state confermate senza essere associate ad alcuna unità locale
        :type num_iscr_sito: str
