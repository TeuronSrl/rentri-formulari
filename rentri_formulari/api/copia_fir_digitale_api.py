...
class CopiaFIRDigitaleApi:
    ...
    def copia_digitale_caricamento_num_iscr_sito_get(self, num_iscr_sito : Annotated[StrictStr, Field(..., description="Numero iscrizione unità locale del destinatario che ha caricato le copie dei FIR digitali")], numero_fir : Annotated[Optional[StrictStr], Field(description="Numero FIR della copia del FIR digitale")] = None, tipo_accettazione : Annotated[Optional[Any], Field(description="Filtra le copia dei FIR digitali per tipo di accettazione del destinatario")] = None, confermate : Annotated[Optional[StrictBool], Field(description="Filtra le copie dei FIR digitali confermate o non confermate.")] = None, comune_id : Annotated[Optional[StrictStr], Field(description="Filtra le copie dei FIR digitali per il comune. Il valore viene considerato solo per il ruolo di produttore")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, codice_eer : Annotated[Optional[constr(strict=True, max_length=8)], Field(description="Filta le copie digiitali dei FIR per il codice EER del rifiuto")] = None, ruolo : Annotated[Optional[Any], Field(description="Ruolo per il quale si richiedono le copie dei FIR digitali da confermare")] = None, paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize")] = None, **kwargs) -> List[CopiaDigitaleItemResult]:  # noqa: E501
        ...
        Ottiene la lista delle copie dei FIR digitali caricate dal destinatario e rese disponibili agli altri soggetti del FIR.  # noqa: E501
    ...
    def copia_digitale_caricamento_num_iscr_sito_identificativo_delete(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del destinatario che ha caricato la copia del FIR digitale.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR digitale da cancellare")], **kwargs) -> None:  # noqa: E501
        ...
        Elimina il caricamento della copia del FIR digitale. L'operazione è possibile solo se nessuno dei soggetti a cui è stata resa disponibile la copia del FIR digitale ne ha già preso visione con l'operazione di conferma.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_digitale_caricamento_num_iscr_sito_identificativo_documento_get(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del destinatario che ha caricato la copia del FIR digitale.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR digitale della quale restituire il documento caricato")], **kwargs) -> DownloadableBaseResponse:  # noqa: E501
        ...
        Restituisce il file xFIR precedentemente caricato dal destinatario stesso.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_digitale_caricamento_num_iscr_sito_identificativo_get(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del destinatario che ha caricato la copia del FIR digitale.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR digitale")], **kwargs) -> CopiaDigitaleResult:  # noqa: E501
        ...
        Recupera le informazioni di dettaglio del caricamento della copia del FIR digitale.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_digitale_conferma_identificativo_soggetto_get(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per cui richiedere l'elenco delle copie dei FIR digitali disponibili")], num_iscr_sito : Annotated[Optional[StrictStr], Field(description="Eventuale numero di iscrizione dell'unità locale per la quale si richiedono le copie dei FIR digitali")] = None, numero_fir : Annotated[Optional[StrictStr], Field(description="Numero FIR della copia del FIR digitale")] = None, tipo_accettazione : Annotated[Optional[Any], Field(description="Filtra le copia dei FIR digitali per tipo di accettazione del destinatario")] = None, confermate : Annotated[Optional[StrictBool], Field(description="Filtra le copie dei FIR digitali confermate o non confermate.")] = None, comune_id : Annotated[Optional[StrictStr], Field(description="Filtra le copie dei FIR digitali per il comune. Il valore viene considerato solo per il ruolo di produttore")] = None, data_emissione_da : Annotated[Optional[datetime], Field(description="Data di emissione a partire dalla quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, data_emissione_a : Annotated[Optional[datetime], Field(description="Data massima di emissione entro la quale si richiedono le copie dei FIR digitali (formato ISO 8601 UTC)")] = None, codice_eer : Annotated[Optional[constr(strict=True, max_length=8)], Field(description="Filta le copie digiitali dei FIR per il codice EER del rifiuto")] = None, ruolo : Annotated[Optional[Any], Field(description="Ruolo per il quale si richiedono le copie dei FIR digitali da confermare")] = None, paging_page : Annotated[Optional[conint(strict=True, le=2147483647, ge=1)], Field(description="Valore per l'header Paging-Page")] = None, paging_page_size : Annotated[Optional[conint(strict=True, le=1000, ge=1)], Field(description="Valore per l'header Paging-PageSize")] = None, **kwargs) -> List[CopiaDigitaleItemResult]:  # noqa: E501
        ...
        :param num_iscr_sito: Eventuale numero di iscrizione dell'unità locale per la quale si richiedono le copie dei FIR digitali
        :type num_iscr_sito: str
        :param numero_fir: Numero FIR della copia del FIR digitale
        :type numero_fir: str
        :param tipo_accettazione: Filtra le copia dei FIR digitali per tipo di accettazione del destinatario
    ...
    @validate_arguments
    def copia_digitale_conferma_identificativo_soggetto_identificativo_documento_get(self, identificativo_soggetto : Annotated[StrictStr, Field(..., description="Codice fiscale del soggetto per il quale si richiede il documento della copia del FIR digitale")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR digitale caricata dal destinatario")], **kwargs) -> DownloadableBaseResponse:  # noqa: E501
        """Documento copia FIR digitale disponibile  # noqa: E501

        Restituisce il file xFIR che rappresenta la copia del FIR digitale caricata dal destinatario.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :type identificativo_soggetto: str
        :param identificativo: Identificativo della copia del FIR digitale caricata dal destinatario (required)
        :type identificativo: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
    ...
    def copia_digitale_conferma_num_iscr_sito_identificativo_put(self, num_iscr_sito : Annotated[constr(strict=True), Field(..., description="Numero iscrizione unità locale del soggetto che conferma la presa visione della copia del FIR digitale.             Per recuperare i numeri di iscrizione attribuiti alle unità locali è possibile utilizzare /anagrafiche/v1.0/operatore/{num_iscr}/siti.")], identificativo : Annotated[StrictStr, Field(..., description="Identificativo della copia del FIR digitale della quale restituire il file xFIR caricato")], ruolo : Annotated[Optional[Any], Field(description="Ruolo all'interno del FIR del soggetto per cui si effettua l'operazione di conferma di presa visione.              In caso di ambiguità (lo stesso soggetto a cui si riferisce l'unità locale \"numIscrSito\" appare con più ruoli all'interno del FIR) il parametro è obbligatorio")] = None, respingi : Annotated[Optional[StrictBool], Field(description="Se valorizzato a true annulla una eventuale precedente operazione di presa visione per i parametri specificati")] = None, **kwargs) -> None:  # noqa: E501
        ...
        Permette al soggetto a cui è stata resa disponibile la copia del FIR digitale di impostarne la stato di presa visione.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def copia_digitale_transazione_id_status_get(self, transazione_id : Annotated[StrictStr, Field(..., description="Id della richiesta")], **kwargs) -> None:  # noqa: E501
        ...
        Ottiene lo stato di elaborazione di una richiesta di caricamento di una copia di un FIR digitale.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
