...
from rentri_formulari.models.esito_upload_xfir_model import EsitoUploadXfirModel  # noqa: E501

class TestEsitoUploadXfirModel(unittest.TestCase):
    """EsitoUploadXfirModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EsitoUploadXfirModel:
        """Test EsitoUploadXfirModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EsitoUploadXfirModel`
        """
        model = EsitoUploadXfirModel()  # noqa: E501
        if include_optional:
            return EsitoUploadXfirModel(
    ...
    def testEsitoUploadXfirModel(self):
        """Test EsitoUploadXfirModel"""
