# DestinatarioSuccessivoResultModel
...
# create an instance of DestinatarioSuccessivoResultModel from a dict
destinatario_successivo_result_model_from_dict = DestinatarioSuccessivoResultModel.from_dict(destinatario_successivo_result_model_dict)
```
