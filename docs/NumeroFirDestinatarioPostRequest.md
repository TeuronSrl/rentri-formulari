...
# create an instance of NumeroFirDestinatarioPostRequest from a dict
numero_fir_destinatario_post_request_from_dict = NumeroFirDestinatarioPostRequest.from_dict(numero_fir_destinatario_post_request_dict)
```
