...
**quantita_accettata** | **float** | Quantita accettata in kg | [optional] 
...
copia_digitale_accettazione_result_instance = CopiaDigitaleAccettazioneResult.from_json(json)
# print the JSON string representation of the object
print(CopiaDigitaleAccettazioneResult.to_json())

# convert the object into a dict
copia_digitale_accettazione_result_dict = copia_digitale_accettazione_result_instance.to_dict()
# create an instance of CopiaDigitaleAccettazioneResult from a dict
copia_digitale_accettazione_result_from_dict = CopiaDigitaleAccettazioneResult.from_dict(copia_digitale_accettazione_result_dict)
```
