...
json = "{}"
# create an instance of DatiDestinatarioTrasmissioneModel from a JSON string
dati_destinatario_trasmissione_model_instance = DatiDestinatarioTrasmissioneModel.from_json(json)
# print the JSON string representation of the object
print DatiDestinatarioTrasmissioneModel.to_json()

# convert the object into a dict
dati_destinatario_trasmissione_model_dict = dati_destinatario_trasmissione_model_instance.to_dict()
# create an instance of DatiDestinatarioTrasmissioneModel from a dict
dati_destinatario_trasmissione_model_from_dict = DatiDestinatarioTrasmissioneModel.from_dict(dati_destinatario_trasmissione_model_dict)
```
