...
dati_destinatario_formulario_result_model_instance = DatiDestinatarioFormularioResultModel.from_json(json)
# print the JSON string representation of the object
print(DatiDestinatarioFormularioResultModel.to_json())

# convert the object into a dict
dati_destinatario_formulario_result_model_dict = dati_destinatario_formulario_result_model_instance.to_dict()
# create an instance of DatiDestinatarioFormularioResultModel from a dict
dati_destinatario_formulario_result_model_from_dict = DatiDestinatarioFormularioResultModel.from_dict(dati_destinatario_formulario_result_model_dict)
```
