...
**dati_firma** | [**DatiFirmaResult**](DatiFirmaResult.md) | Dati relativi alla firma per l&#39;inserimento del nuovo destinatario | [optional] 
...
json = "{}"
# create an instance of DatiDestinatarioSuccessivoResultModel from a JSON string
dati_destinatario_successivo_result_model_instance = DatiDestinatarioSuccessivoResultModel.from_json(json)
# print the JSON string representation of the object
print(DatiDestinatarioSuccessivoResultModel.to_json())

# convert the object into a dict
dati_destinatario_successivo_result_model_dict = dati_destinatario_successivo_result_model_instance.to_dict()
# create an instance of DatiDestinatarioSuccessivoResultModel from a dict
dati_destinatario_successivo_result_model_from_dict = DatiDestinatarioSuccessivoResultModel.from_dict(dati_destinatario_successivo_result_model_dict)
```
