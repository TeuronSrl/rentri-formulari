...
**azioni** | [**List[Operazione]**](Operazione.md) | Elenco delle operazioni effettuabili sul formulario abilitate per il soggetto specificato,  in funzione dello stato in cui si trova il formulario | [optional] 
