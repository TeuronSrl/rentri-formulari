...
# create an instance of DatiPartenzaModelDestinatario from a dict
dati_partenza_model_destinatario_from_dict = DatiPartenzaModelDestinatario.from_dict(dati_partenza_model_destinatario_dict)
```
